            ...
            <div id="store_area">
                <div id="store_header">
                    <div id="search">
                        ...
                        <div id="search_btn"><i class="fa fa-search text-white"></i></div>
                    </div>

                    <div id="drop_box">
                        <div id="drop_box_title"><i class="fa fa-shopping-cart text-white"></i></div>
                        <div id="drop_box_area">이곳에 상품을 넣어주세요.</div>
                    </div>
                </div>
                <div id="store_body">
                    <div id="store_list">
