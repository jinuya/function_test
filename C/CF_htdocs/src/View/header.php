                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h3 class="modal-title text-center d-block w-100">회원가입</h3>
                                </div>
                                <div class="modal-body">
                                    <form action="/join" method="post" name="join_form" id="join_form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <canvas id="captcha" class='border border-secondary rounded w-100'></canvas>
                                ...
                                <div class="modal-footer">
                                    <button class="footer_btn m-0" id="join_btn">가입 완료</button>
                    ...
                    <div id="login_popup" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button class="footer_btn m-0" id="login_btn">로그인</button>
                                    <button class="footer_btn m-0" data-dismiss="modal">닫기</button>
                                </div>
                            </div>
                        </div>
