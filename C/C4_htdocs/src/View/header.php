    ...
    <div id="wrap">
        ...
        <header>
            ...
            <div id="user_area">
                ...
                <?php else:?>
                    <a href="#" data-toggle="modal" data-target="#login_popup" class="main_user login_open main_not480">로그인</a>
                    <a href="#" data-toggle="modal" data-target="#login_popup" class="main_user login_open main_480"><i class="fa fa-sign-in"></i></a>
                    <a href="#" data-toggle="modal" data-target="#join_popup" class="main_user join_open main_not480">회원가입</a>
                    <a href="#" data-toggle="modal" data-target="#join_popup" class="main_user join_open main_480"><i class="fa fa-user-plus"></i></a>
                <?php endif;?>
            </div>
