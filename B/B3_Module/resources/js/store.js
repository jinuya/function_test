class store{
    ...
    MakeItem(item){
        ...
        card.innerHTML = `<img src="resources/images/${item.photo}" data-id="${item.id}" alt="store_img" title="store_img" class="card-img-top store_img" draggable>
                             <div class="card-body border-top">
                                 <h5 class="card-title">${item.product_name}</h5>
                                 <p class="card-subtitle">${item.brand}</p>
                                 <p class="card-subtitle text-right text-muted">${item.price}원</p>
                             </div>`;
